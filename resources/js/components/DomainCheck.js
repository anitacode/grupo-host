...
Searcher.propTypes = {
    domainToSearchVal: PropTypes.string,
    multiple: PropTypes.bool,
    target: PropTypes.string,
    checkDomain: PropTypes.func,
    show: PropTypes.bool,
    setMultiple: PropTypes.bool,
    setDomainToSearchVal: PropTypes.func
}
...
DomainTable.propTypes = {
    checkDomainData: PropTypes.array,
    setWhois: PropTypes.func,
...
const DomainCheck = () => {
    ...
    const checkDomainAvailable = async () =>{
        let tosend = domainToSearchVal.replaceAll('\r\n','|')
        await fetching(config, global, 'checkdomain', setCheckDomainData,{ domains : tosend });
